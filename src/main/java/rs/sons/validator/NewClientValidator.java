...
public class NewClientValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if(clientService.findClientByEmail(client.getClient_email()) != null) {
			errors.rejectValue("client_email", null, "Email address already exists !!!");
		}
		
		if(clientService.findClientByIdentificationNumber(client.getClient_identification_number()) != null) {
			errors.rejectValue("client_identification_number", null, "Identification number already exists !!!");
		}
		
		if(clientService.findClientByIdentificationNumber(client.getClient_pib()) != null) {
